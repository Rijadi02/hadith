...
function send_request($collection, $number)
{
    $curl = curl_init();

    curl_setopt_array($curl, array(
        CURLOPT_URL => "https://api.sunnah.com/v1/collections/$collection/hadiths/$number",
        ...
        CURLOPT_HTTPHEADER => array(
            "x-api-key: 0ptn7nODK9aBGCo0Iykp6a1FpPlljCaa7yikzW5l"
        ),
    ));
...
function random_request()
{
    ...
    foreach ($random_obj as $key => $value) {
        ...
        $request = send_request($key, $random_hadith);
