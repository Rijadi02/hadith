                ...
                flex-direction: column;">
                  <div class="mobileHide pb-5">
                    ...
                    <p class="page-header-title pb-4">
                      ...
                      <div>
                        ...
                        <p href="#" id="libra" class="libra"><?php echo $hadith->id ?>, <?php echo $hadith->get_chapter()->NrKapitulli ?>, <?php echo $hadith->get_book()->Libri ?></p>
                      </div>
                    </p>
                  ...
                  <div class="mobileShow">
                    <p class="page-header-title py-5 my-5 mobileShow">
                      ...
                      <p href="#" class="libraM">
                        <?php echo $hadith->id ?>, <?php echo $hadith->get_chapter()->NrKapitulli ?>, <?php echo $hadith->get_book()->Libri ?></p>
