    ...
    <body >
        <div id="layoutDefault" style="width: 100%;
            ...
            <div id="layoutDefault_content" style="width: 100%; height: 100%;">
                ...
                <header class="page-header my-0 py-0 bg-img-cover " style='background-image: url("https://i.pinimg.com/originals/5e/65/20/5e6520289b44e11a9e74363c18ce3ee1.jpg"); width: 100%; height: 100% !important; background-repeat: repeat-y !important;'>
                    <div class="blur"></div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-xl-8 col-lg-10 text-center">
                                        <div data-aos="fade-up">
                                            ...
                                            <p class="page-header-title py-5 my-5 mobileHide">
                                                <a href="#" class="a-title" >Albanian</a> &nbsp;
                                                | 
                                                &nbsp;  
                                                <a href="#" class="a-title">English</a> &nbsp;
                                                | 
                                                &nbsp; <a href="#" class="a-title">Arabic</a></p>
                                            <div class="py-3 mobileHide" ></div>
                                            <div class="py-3 mobileHide"></div>
